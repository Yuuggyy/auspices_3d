...
INSERT INTO public.categories (nom, emoji, ordre) VALUES ('Plats Congolais', '🍲', 0) RETURNING id;
INSERT INTO public.categories (nom, emoji, ordre) VALUES ('Accompagnements', '🍚', 1) RETURNING id;
